			...
			<view :style='{"minHeight":"100%","alignContent":"flex-start","padding":"120rpx 24rpx 240rpx 24rpx","alignItems":"flex-start","flexWrap":"wrap","background":"#ffffff","display":"block","width":"100%","position":"relative","height":"auto"}'>
				<view class="cu-bar bg-white search" :style='{"padding":"20rpx 0 0 0","margin":"0","background":"none","display":"flex","width":"100%","position":"relative","height":"auto"}'>
					<view  :style='{"border":"none","margin":"0","borderRadius":"20rpx","flex":"1","background":"none","lineHeight":"80rpx","position":"relative","height":"80rpx"}' class="search-form round">
						...
						<input  :style='{"border":"0","padding":"12rpx 20rpx 12rpx 80rpx","color":"#8262c5","borderRadius":"40rpx","background":"#8262c520","width":"100%","lineHeight":"80rpx","fontSize":"28rpx","height":"80rpx"}' v-model="searchForm.wenzhangbiaoti" type="text" placeholder="文章标题" ></input>
					</view>
					<button :style='{"border":"0","padding":"0px","margin":"0 0 0 10rpx","color":"#fff","borderRadius":"40rpx","background":"linear-gradient(126deg, #b295f7 3%,#8262c5 97%)","width":"136rpx","lineHeight":"80rpx","fontSize":"28rpx","height":"80rpx","zIndex":"99"}' @tap="search" class="cu-btn shadow-blur round">搜索</button>
				</view>
				...
				<view :style='{"padding":"20rpx 0","margin":"20rpx 0 20rpx 0","borderRadius":"0","flexWrap":"wrap","background":"none","display":"flex","justifyContent":"center"}'>
					<view @click="sortClick('clicknum')" :style='{"border":"0","padding":"0 12rpx 0 12rpx","margin":"0 20rpx 20rpx 0","outline":"0","borderRadius":"8rpx","display":"flex"}'>
				...
				<view :style='{"alignContent":"flex-start","alignItems":"flex-start","flexWrap":"wrap","background":"#ffffff","display":"flex","width":"100%","position":"initial","height":"auto","order":"4"}'>
					<scroll-view scroll-x="true" class="category-one" :style='{"padding":"20rpx","margin":"0","whiteSpace":"nowrap","borderRadius":"0 0 40rpx 40rpx","top":"0","left":"0","background":"#8262c520","flexDirection":"row","display":"flex","width":"100%","position":"absolute","height":"auto"}'>
					...
					<view class="uni-product-list" :style='{"padding":"0","margin":"0px 0 0 0","flexWrap":"wrap","flex":"auto","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
						<view @tap="onDetailTap(product)" class="uni-product" :style='{"border":"2rpx solid #8262c530","boxShadow":"none","padding":"16rpx","margin":"0 0 30rpx 0","overflow":"hidden","borderRadius":"20rpx","flexWrap":"wrap","background":"#fff","display":"flex","width":"48%","height":"auto"}' v-for="(product,index) in list" :key="index">
							<view class="uni-product-title" :style='{"padding":"0","overflow":"hidden","color":"#333","maxHeight":"96rpx","width":"100%","lineHeight":"48rpx","fontSize":"28rpx"}'>{{product.wenzhangbiaoti}}</view>
							<image :style='{"border":"20rpx solid #4D357B20","padding":"0","margin":"0 0 4rpx 0","objectFit":"cover","borderRadius":"20rpx","display":"block","width":"100%","height":"300rpx","order":"-1"}' mode="aspectFill" class="uni-product-image" v-if="preHttp(product.fengmiantupian)" :src="product.fengmiantupian.split(',')[0]"></image>
							<image :style='{"border":"20rpx solid #4D357B20","padding":"0","margin":"0 0 4rpx 0","objectFit":"cover","borderRadius":"20rpx","display":"block","width":"100%","height":"300rpx","order":"-1"}' mode="aspectFill" class="uni-product-image" v-else :src="product.fengmiantupian?baseUrl+product.fengmiantupian.split(',')[0]:''"></image>
							<view class="uni-product-title" :style='{"padding":"0","overflow":"hidden","color":"#333","maxHeight":"96rpx","width":"100%","lineHeight":"48rpx","fontSize":"28rpx"}'>{{product.zhishifenlei}}</view>
							...
							<view :style='{"padding":"0 10rpx 0 0","order":"6"}'>
							...
							<view :style='{"width":"100%","padding":"0","justifyContent":"space-between","display":"flex","height":"auto","order":"11"}'>
								<view :style='{"padding":"8rpx 12rpx","background":"none","justifyContent":"center","display":"flex"}' v-if="(userid && isAuth('xinlizhishi','修改')) || (!userid && isAuthFront('xinlizhishi','修改'))" @tap.stop.proevent="onUpdate" :data-row="product">
								...
								<view :style='{"padding":"8rpx 12rpx","background":"none","justifyContent":"center","display":"flex"}' v-if="(userid && isAuth('xinlizhishi','删除')) || (!userid && isAuthFront('xinlizhishi','删除'))" @tap.stop.proevent="onDelete" :data-row="product">
							...
							<!-- #ifndef MP-WEIXIN -->
							<view :style='{"width":"100%","padding":"0","justifyContent":"space-between","display":"flex","height":"auto","order":"11"}'>
								<view :style='{"padding":"8rpx 12rpx","background":"none","justifyContent":"center","display":"flex"}' v-if="(userid && isAuth('xinlizhishi','修改')) || (!userid && isAuthFront('xinlizhishi','修改'))" @tap.stop.proevent="onUpdateTap(product)">
									<text :style='{"margin":"0 8rpx 0 0","fontSize":"24rpx","lineHeight":"1","color":"#42a5f9","display":"inline-block"}' class="cuIcon-edit"></text>
									<text :style='{"fontSize":"24rpx","lineHeight":"1","whiteSpace":"nowrap","color":"#42a5f9","display":"inline-block"}'>修改</text>
								</view>
								<view :style='{"padding":"8rpx 12rpx","background":"none","justifyContent":"center","display":"flex"}' v-if="(userid && isAuth('xinlizhishi','删除')) || (!userid && isAuthFront('xinlizhishi','删除'))" @tap.stop.proevent="onDeleteTap(product.id)">
									<text :style='{"margin":"0 8rpx 0 0","fontSize":"24rpx","lineHeight":"1","color":"#ff0000","display":"inline-block"}' class="cuIcon-delete"></text>
									<text :style='{"fontSize":"24rpx","lineHeight":"1","whiteSpace":"nowrap","color":"#ff0000","display":"inline-block"}'>删除</text>
								</view>
							</view>
				...
				<button :style='{"border":"0","boxShadow":"0 2rpx 12rpx #dddddd","margin":"20rpx 0 0 0","color":"#fff","bottom":"0","outline":"none","borderRadius":"20rpx","left":"0","background":"#b295f7","width":"120rpx","lineHeight":"70rpx","fontSize":"28rpx","position":"relative","height":"70rpx","zIndex":"1"}' class="add-btn" @click="screenBoxShow=true">筛</button>
				<button :style='{"border":"0","boxShadow":"0 2rpx 12rpx #dddddd","padding":"0 30rpx","margin":"0 10rpx 0 0","color":"#fff","bottom":"0","right":"0","outline":"none","borderRadius":"20rpx","background":"#b295f7","width":"auto","lineHeight":"70rpx","fontSize":"28rpx","position":"relative","height":"70rpx","zIndex":"1"}' v-if="userid && isAuth('xinlizhishi','新增')" class="add-btn" @click="onAddTap()">新增</button>
				<button :style='{"border":"0","boxShadow":"0 2rpx 12rpx #dddddd","padding":"0 30rpx","margin":"0 10rpx 0 0","color":"#fff","bottom":"0","right":"0","outline":"none","borderRadius":"20rpx","background":"#b295f7","width":"auto","lineHeight":"70rpx","fontSize":"28rpx","position":"relative","height":"70rpx","zIndex":"1"}' v-if="!userid && isAuthFront('xinlizhishi','新增')" class="add-btn" @click="onAddTap()">新增</button>
				...
				<view class="screenBox" :class="screenBoxShow?'screenBoxActive':''">
					<view  :style='{"width":"100%","padding":"20rpx 0 20rpx 0","alignItems":"center","justifyContent":"space-around","display":"flex"}'>
						<view :style='{"width":"18%","padding":"0 0 0 20rpx","fontSize":"24rpx"}'>心理文章</view>
						<input :style='{"border":"2rpx solid rgb(162, 144, 104)","width":"80%","padding":"0 20rpx 0 20rpx","borderRadius":"40rpx","background":"none","height":"60rpx"}' placeholder="请输入心理文章" v-model="searchForm.xinliwenzhang">
					</view>
					<view  :style='{"width":"100%","padding":"20rpx 0 20rpx 0","alignItems":"center","justifyContent":"space-around","display":"flex"}'>
						<view :style='{"width":"18%","padding":"0 0 0 20rpx","fontSize":"24rpx"}'>知识详情</view>
						<input :style='{"border":"2rpx solid rgb(162, 144, 104)","width":"80%","padding":"0 20rpx 0 20rpx","borderRadius":"40rpx","background":"none","height":"60rpx"}' placeholder="请输入知识详情" v-model="searchForm.zhishixiangqing">
					</view>
					<view  :style='{"width":"100%","padding":"20rpx 0 20rpx 0","alignItems":"center","justifyContent":"space-around","display":"flex"}'>
						<view :style='{"width":"18%","padding":"0 0 0 20rpx","fontSize":"24rpx"}'>医生姓名</view>
						<input :style='{"border":"2rpx solid rgb(162, 144, 104)","width":"80%","padding":"0 20rpx 0 20rpx","borderRadius":"40rpx","background":"none","height":"60rpx"}' placeholder="请输入医生姓名" v-model="searchForm.yishengxingming">
					</view>
	...
	export default {
		...
		methods: {
			...
			async upCallback(mescroll) {
				...
				if(this.searchForm.xinliwenzhang){
					params['xinliwenzhang'] = '%' + this.searchForm.xinliwenzhang + '%'
				}
				if(this.searchForm.zhishixiangqing){
					params['zhishixiangqing'] = '%' + this.searchForm.zhishixiangqing + '%'
				}
                ...
                let res = {}
                if(this.userid) {
                    res = await this.$api.page(`xinlizhishi`, params);
                } else {
                    res = await this.$api.list(`xinlizhishi`, params);
                }
			...
			onDeleteTap(id){
				...
				uni.showModal({
					...
					success: async function(res) {
						if (res.confirm) {
							await that.$api.del('xinlizhishi', JSON.stringify([id]));
			...
			async search(){
				...
				if(this.searchForm.xinliwenzhang){
					searchForm['xinliwenzhang'] = '%' + this.searchForm.xinliwenzhang + '%'
				}
				if(this.searchForm.zhishixiangqing){
					searchForm['zhishixiangqing'] = '%' + this.searchForm.zhishixiangqing + '%'
				}
				if(this.searchForm.yishengxingming){
				...
				let res = {};
				if(this.userid) {
					res = await this.$api.page(`xinlizhishi`, searchForm);
				} else {
					res = await this.$api.list(`xinlizhishi`, searchForm);
				}
				// 如果是第一页数据置空
...
<style lang="scss" scoped>
	...
	.screenBox {
		...
		height: 100%;
		box-shadow: -16rpx 0 44rpx rgba(42, 55, 78, .16);
		.screenTab {
