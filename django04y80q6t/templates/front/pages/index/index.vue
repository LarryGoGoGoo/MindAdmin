		...
		<view :style='{"width":"100%","padding":"0 0 40rpx 0","background":"#fff","flexDirection":"column","display":"flex","height":"auto"}'>
			...
			<view class="cu-bar bg-white search" :style='{"width":"100%","padding":"20rpx 24rpx","position":"relative","background":"none","display":"flex","height":"auto"}'>
				...
				<view :style='{"border":"none","margin":"0","position":"relative","borderRadius":"40rpx","flex":"1","background":"none"}' v-if="queryIndex==0" class="search-form round">
					...
					<input placeholder-style="color: #8262c5" :style='{"border":"0","padding":"12rpx 20rpx 12rpx 80rpx","color":"#8262c5","borderRadius":"40rpx","background":"#8262c520","width":"100%","lineHeight":"80rpx","fontSize":"28rpx","height":"80rpx"}' v-model="searchForm.xinlizhishiwenzhangbiaoti" type="text" placeholder="文章标题" ></input>
				</view>
				<button :style='{"border":"0","padding":"0px","margin":"0 0 0 10rpx","color":"#fff","borderRadius":"40rpx","background":"linear-gradient(126deg, #b295f7 3%,#8262c5 97%)","width":"136rpx","lineHeight":"80rpx","fontSize":"28rpx","height":"80rpx"}' v-if="queryIndex==0" @tap="onPageTap('xinlizhishi')" class="cu-btn shadow-blur round">搜索</button>
			</view>
			...
			<view class="listBox recommend" :style='{"padding":"0 20rpx","margin":"40rpx 0 0","background":"none","order":"1"}'>
				<view class="title" :style='{"padding":"0 20rpx 0 60rpx","margin":"0","background":"url(http://codegen.caihongy.cn/20250813/599b0f53d88f438a9cae979efe780834.png) no-repeat center center / 100% auto","display":"flex","width":"100%","position":"relative","justifyContent":"space-between","height":"76rpx"}'>
				...
				<view class="list-box style1" :style='{"padding":"0","margin":"40rpx 0 0 0","flexWrap":"wrap","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
					<view @tap="onDetailTap('xinlizhishi',product.id)" v-for="(product,index) in xinlizhishilist" :key="index" class="list-item" :style='{"border":"2rpx solid #8262c530","padding":"4rpx","margin":"0 0 30rpx 0","borderRadius":"10rpx","flexWrap":"wrap","display":"flex","width":"32%","height":"auto"}'>
			...
			<view class="listBox news" :style='{"width":"100%","padding":"0 20rpx","margin":"40rpx 0 0","background":"none","order":"2"}'>
				<view class="title" :style='{"padding":"0 0 0 60rpx","margin":"0","background":"url(http://codegen.caihongy.cn/20250813/599b0f53d88f438a9cae979efe780834.png) no-repeat center center / 100% auto","display":"flex","width":"100%","position":"relative","justifyContent":"start","height":"76rpx"}'>
					<view :style='{"color":"#fff","fontSize":"32rpx","lineHeight":"76rpx"}'>发布信息</view>
...
<style lang="scss" scoped>
	...
	.quick-entry-main {
		padding: 24rpx;
		border-radius: 16rpx;
		background: linear-gradient(135deg, #f3edff 0%, #e8f7f6 100%);
		display: flex;
		align-items: center;
		min-height: 128rpx;
	}
