	...
	<view class="content">
		<view class="login-box" :style="{'backgroundImage': indexBgUrl?`url(${$base.url + indexBgUrl})`:''}">
			<view :style='{"width":"100%","padding":"0","position":"relative","borderRadius":"20rpx","background":"none","height":"auto"}'>
				...
				<view v-if="loginType==1" :style='{"margin":"0 0 40rpx 0","borderColor":"#ECE0FF","alignItems":"center","borderRadius":"60rpx","borderWidth":"0 0 0px 0","background":"#00000050","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="uni-form-item uni-column">
					<view :style='{"padding":"0 20rpx 0 40rpx","color":"#FFFFFF","borderRadius":"0px 60rpx 60rpx 0px","textAlign":"center","background":"none","flex":"none","width":"auto","lineHeight":"50rpx","fontSize":"28rpx","height":"50rpx"}' class="label">账号：</view>
				...
				<view v-if="roleNum>1&&loginType<=2" :style='{"margin":"0 0 24rpx 0","borderColor":"#ECE0FF","alignItems":"center","borderRadius":"60rpx","borderWidth":"0 0 0px 0","background":"#00000050","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
				...
				<button v-if="loginType==1||loginType==3||loginType==4" class="btn-submit" @tap="onLoginTap" type="primary" :style='{"border":"0","padding":"0px","margin":"40rpx 0 24rpx 0","color":"#fff","borderRadius":"40rpx","background":"linear-gradient(126deg, #b295f780 3%,#8262c560 97%)","width":"100%","lineHeight":"80rpx","fontSize":"32rpx","fontWeight":"600","height":"80rpx"}'>登录</button>
				<button v-if="loginType==2" class="btn-submit" @tap="onFaceLoginTap" type="primary" :style='{"border":"0","padding":"0px","margin":"40rpx 0 24rpx 0","color":"#fff","borderRadius":"40rpx","background":"linear-gradient(126deg, #b295f780 3%,#8262c560 97%)","width":"100%","lineHeight":"80rpx","fontSize":"32rpx","fontWeight":"600","height":"80rpx"}'>人脸识别登录</button>
...
<style lang="scss" scoped>
	...
	.login-box {
		padding: 0 56rpx;
		background: url(http://codegen.caihongy.cn/20250813/1ab7b9e3e8fa4e2989a1b965131069db.jpg) no-repeat center top / cover;
		display: flex;
		width: 100%;
		min-height: 100vh;
		align-items: center;
