<template>
	<view :style='{"minHeight":"100%","width":"100%","padding":"24rpx","position":"relative","background":"#fff","height":"auto"}'>
		...
		<div :style='{"width":"100%","padding":"0","margin":"20rpx 0 20rpx 0","justifyContent":"space-between","display":"flex","height":"auto"}'>
			<div @click="prepDetailClick" :style='{"padding":"0 20rpx","color":"#645580","background":"#64558020","flex":"auto","width":"0","lineHeight":"80rpx","fontSize":"28rpx"}'>上一篇：prev</div>
			<div @click="nextDetailClick" :style='{"padding":"0 20rpx","color":"#4D357B","background":"#4D357B30","flex":"auto","width":"0","lineHeight":"80rpx","fontSize":"28rpx"}'>下一篇：next</div>
		</div>
